export default {
    ...
    */
    ...
    setURLS: {
        GPElementSets           : (set: string, format: string) => `/NORAD/elements/gp.php?GROUP=${set}&FORMAT=${format}`,
        elementSets             : (set: string)                 => `/satcat/${set}.php`,
        supplementalElementSets : (set: string)                 => `/NORAD/elements/supplemental/${set}.txt`,
    },
