 ...
 */
export declare type SemverNode = {
    major: number;
    minor: number;
    patch: number;
 ...
 */
export declare type AppEnvironments = 'web' | 'console' | 'test' | 'unknown';
/**
 ...
 */
export declare type GlobalFlagHandler = (value: any, parsed: ParsedOptions, command?: CommandContract) => any;
/**
